        ...
        <AnimatePresence mode="wait">
          {phase === "camera" && (
            <motion.div key="camera" className="absolute inset-0 flex flex-col items-center justify-end pb-12">
              ...
              <button onClick={handleCapture} className="w-20 h-20 bg-white rounded-full border-4 border-gray-300 flex items-center justify-center shadow-[0_0_0_4px_rgba(255,255,255,0.2)]">
